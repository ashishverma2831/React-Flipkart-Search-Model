                    ...
                    {brands.map((brand) => {
                        return (
                            <div class="flex items-center mb-4">
                                <input id="default-checkbox" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded" checked={selectedBrand.includes(brand.toLowerCase())} onChange={(e)=>{handleBrand(e,brand.toLowerCase())}}/>
